...
function MenuController( $scope, $rootScope )
{
	...
	$scope.GModPatchToolStatus = document.createElement("video").canPlayType('video/mp4; codecs="avc1.42E01E, mp4a.40.2"') == "probably";
	$scope.ShowGModPatchToolInfo = function()
	{
		lua.Run( "gui.OpenURL( 'https://github.com/solsticegamestudios/GModPatchTool' )" );
	}
}
